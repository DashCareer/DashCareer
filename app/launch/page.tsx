...
export default async function LaunchPage() {
  ...
  const checks = [
    ...
    { title: "Independent login", detail: "Email/password accounts use DashCareer branding and Supabase. Google sign-in can be enabled separately.", done: Boolean(process.env.NEXT_PUBLIC_SUPABASE_URL) },
